...
namespace
{
  ...
  MovementConstraint constraintFromInt (int i)
  {
    ...
    {
      case 0:
        return MovementConstraint::XAxis;
      case 1:
        return MovementConstraint::YAxis;
      case 2:
        return MovementConstraint::ZAxis;
      case 3:
        return MovementConstraint::XYPlane;
      case 4:
        return MovementConstraint::XZPlane;
      case 5:
        return MovementConstraint::YZPlane;
      case 6:
        return MovementConstraint::CameraPlane;
      case 7:
        return MovementConstraint::PrimaryPlane;
      default:
        DILAY_IMPOSSIBLE
    }
  }
...
template <> void KVStore::set (const std::string& path, const MovementConstraint& c)
{
