...
struct ToolSketchSpheres::Impl
{
  ...
  {
    ViewToolTip toolTip;
    toolTip.add (ViewToolTip::Event::MouseLeft, QObject::tr ("Drag to sketch"));
    ...
    if (e.primaryButton ())
    {
      ...
      else if (this->mesh)
      {
        ...
        if (intersection.isIntersection () && minDistance (intersection))
        {
          ...
          this->mesh->addSphere (false, intersection.position (),
    ...
    if (e.primaryButton ())
    {
      ...
      else
      {
        ...
        if (this->self->intersectsScene (e, intersection))
        {
          ...
          this->mesh->addSphere (true, intersection.position (),
