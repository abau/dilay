...
struct SketchNodeIntersection::Impl
{
  ...
  Impl (SketchNodeIntersection* s)
    : self (s)
  {
  }

  bool update (float d, const glm::vec3& p, const glm::vec3& n, SketchMesh& mesh, SketchNode& node)
  {
...
DELEGATE5 (bool, SketchNodeIntersection, update, float, const glm::vec3&, const glm::vec3&,
