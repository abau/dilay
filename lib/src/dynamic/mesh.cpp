...
struct DynamicMesh::Impl {
  ...
  void forEachVertex ( const DynamicFaces& faces
  ...
  void forEachVertexExt ( const DynamicFaces& faces
                        , const std::function <void (unsigned int)>& f)
  {
    this->unvisitVertices ();
    this->unvisitFaces ();
  ...
  void forEachFaceExt ( const DynamicFaces& faces
                      , const std::function <void (unsigned int)>& f)
  {
    this->unvisitVertices ();
    this->unvisitFaces ();
  ...
  void setAllNormals () {
    this->forEachVertex ([this] (unsigned int i) {
      this->setVertexNormal (i);
    });
  }
  ...
  void realignAllFaces () {
    this->forEachFace ([this] (unsigned int i) {
      this->realignFace (i);
    });
  }
...
DELEGATE4_CONST        (void, DynamicMesh, vertexIndices, unsigned int, unsigned int&, unsigned int&, unsigned int&)
...
DELEGATE2              (void, DynamicMesh, forEachVertex, const DynamicFaces&, const std::function <void (unsigned int)>&)
DELEGATE2              (void, DynamicMesh, forEachVertexExt, const DynamicFaces&, const std::function <void (unsigned int)>&)
DELEGATE1              (void, DynamicMesh, forEachFace, const std::function <void (unsigned int)>&)
DELEGATE2              (void, DynamicMesh, forEachFaceExt, const DynamicFaces&, const std::function <void (unsigned int)>&)
