...
struct PATriangulate6Gon :: Impl {
  ...
  WingedFace& run (WingedMesh& mesh, WingedFace& f, std::list <Id>* affectedFaces) {
    ...
    this->actions.add <PAModifyEdge> ()->increaseFaceGradient (mesh, e01, f);
    this->actions.add <PAModifyEdge> ()->increaseFaceGradient (mesh, e12, f);
    this->actions.add <PAModifyEdge> ()->increaseFaceGradient (mesh, e23, f);
    this->actions.add <PAModifyEdge> ()->increaseFaceGradient (mesh, e34, f);
    this->actions.add <PAModifyEdge> ()->increaseFaceGradient (mesh, e45, f);
    this->actions.add <PAModifyEdge> ()->increaseFaceGradient (mesh, e50, f);
